...
public class Constants {
    static String parPath = System.getProperty("user.dir");
    static String imgPath = parPath + "\\src\\main\\resources\\static\\imgs\\";
    public final static String FILE_UPLOAD_DIC = imgPath;//上传文件的默认url前缀，根据部署设置自行修改
